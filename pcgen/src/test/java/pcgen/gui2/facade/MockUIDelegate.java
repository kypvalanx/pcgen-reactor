...
public class MockUIDelegate implements UIDelegate
{
	...
	/**
	 * @see UIDelegate#maybeShowWarningConfirm(String,
	 *      String, String, PropertyContext,
	 *      String)
	 */
    @Override
	...
	/**
	 * @see UIDelegate#showErrorMessage(String, String)
	 */
    @Override
	...
	/**
	 * @see UIDelegate#showInfoMessage(String, String)
	 */
    @Override
	...
	/**
	 * @see UIDelegate#showLevelUpInfo(CharacterFacade, int)
	 */
    @Override
	...
	/**
	 * @see UIDelegate#showWarningConfirm(String, String)
	 */
    @Override
